...
/* Sequential aggressor — finite, bandwidth-maximizing variant of
 * aggressor_finite.c (standalone BW / prefetch test).
 ...
 *
 * BW-max design (see aggressor_bw.c for rationale): non-volatile `long`,
...
int main(int argc, char *argv[])
{
    ...
    printf("aggressor_finite_bw(%.1fMB x%d pf%ld): sum=%lu\n",
