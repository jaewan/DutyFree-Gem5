...
OUT=$ROOT/logs/final_hotstorage_results_8592_agg4x
PCTS="10 25 53 100"
...
OUT  = ROOT / "logs" / "final_hotstorage_results_8592_agg4x"
TSV  = OUT / "results_final_hotstorage_8592_agg4x.tsv"
LABEL = "8592  4cpu agg4x (final)"
LLC_KIB = 20480
def stat(d, key):
    try:
...
run_all() {
    mkdir -p $OUT
    echo "===== Intel 8592+ final HotStorage (4 CPU, LLC=20MiB, agg=4×LLC, all jobs at once) ====="
