...
mkdir -p logs/intel_latency

echo "=== Launching CHI latency tests ==="

# ── L1 read ───────────────────────────────────────────────────────────────────
build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l1_read_1t_m5out \
    ...
    > logs/intel_latency/l1_read_1t.log 2>&1 &
echo "  started: l1_read_1t"

build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l1_read_8t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    ...
    > logs/intel_latency/l1_read_8t.log 2>&1 &
echo "  started: l1_read_8t"

# ── L1 write ──────────────────────────────────────────────────────────────────
build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l1_write_1t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=1 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l1_write_1t.log 2>&1 &
echo "  started: l1_write_1t"

build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l1_write_8t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=8 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l1_write_8t.log 2>&1 &
echo "  started: l1_write_8t"

# ── L2 read (private per-CPU L2: 512KiB) ─────────────────────────────────────
build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l2_read_1t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=1 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l2_read_1t.log 2>&1 &
echo "  started: l2_read_1t"

build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l2_read_8t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=8 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l2_read_8t.log 2>&1 &
echo "  started: l2_read_8t"

# ── L2 write ──────────────────────────────────────────────────────────────────
build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l2_write_1t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=1 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l2_write_1t.log 2>&1 &
echo "  started: l2_write_1t"

build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l2_write_8t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=8 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l2_write_8t.log 2>&1 &
echo "  started: l2_write_8t"

# ── L3 read (shared HNF: 16MiB) ───────────────────────────────────────────────
build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l3_read_1t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=1 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l3_read_1t.log 2>&1 &
echo "  started: l3_read_1t"

build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l3_read_8t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=8 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l3_read_8t.log 2>&1 &
echo "  started: l3_read_8t"

# ── L3 write ──────────────────────────────────────────────────────────────────
build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l3_write_1t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=1 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l3_write_1t.log 2>&1 &
echo "  started: l3_write_1t"

build_X86_CHI/gem5.opt --outdir=logs/intel_latency/l3_write_8t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=8 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/l3_write_8t.log 2>&1 &
echo "  started: l3_write_8t"

# ── MEM read ──────────────────────────────────────────────────────────────────
build_X86_CHI/gem5.opt --outdir=logs/intel_latency/mem_read_1t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=1 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/mem_read_1t.log 2>&1 &
echo "  started: mem_read_1t"

build_X86_CHI/gem5.opt --outdir=logs/intel_latency/mem_read_8t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=8 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/mem_read_8t.log 2>&1 &
echo "  started: mem_read_8t"

# ── MEM write ─────────────────────────────────────────────────────────────────
build_X86_CHI/gem5.opt --outdir=logs/intel_latency/mem_write_1t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=1 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/mem_write_1t.log 2>&1 &
echo "  started: mem_write_1t"

build_X86_CHI/gem5.opt --outdir=logs/intel_latency/mem_write_8t_m5out \
    configs/deprecated/example/se.py \
    --ruby --topology=Pt2Pt --num-l3caches=1 --num-dirs=1 \
    --cpu-type=TimingSimpleCPU --num-cpus=8 \
    --l1d_size=32KiB --l1d_assoc=8 --l1i_size=64KiB --l1i_assoc=8 \
    ...
    > logs/intel_latency/mem_write_8t.log 2>&1 &
echo "  started: mem_write_8t"

echo ""
echo "All launched (14 tests). Check logs in logs/intel_latency/"
echo "Results: grep 'Exiting @ tick' logs/intel_latency/*.log"
